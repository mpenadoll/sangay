...
float Kd = 10.0; //* derivative gain [V * s / m]
...
const int maxError = 10; //* error [pulses] allowable for position control. 5 pulses = 0.27 mm
...
const float minDegenSpeed = 1; //* minimum speed that degen is effective. 1 pulses/ms = 53.5 mm/s [pulses / ms]
const int minPWM = 255 * 0.0 / 24; //* minimum PWM value that motor will move [analog]
